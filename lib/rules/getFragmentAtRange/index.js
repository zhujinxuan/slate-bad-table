...
function makePatch(opts: Options): typePatch {
    return {
        ...
        utils: {
            getFragmentAtRange: (node, range) =>
                getFragmentAtRange(opts, node, range)
        }
    };
}
function getFragmentAtRange(opts: Options, node: Node, range: Range): Document {
