...
function bindRules(
    ...
    if (index === rules.length) {
        return change.insertFragmentAtRange(range, { normalize: false });
    }
...
function insertFragmentAtRange(
    ...
    bindRules(insertFragmentRules, 0, opts, change, range, fragment);

    return insertOptions.normalize ? change.normalize() : change;
}
